...
# There is a race condition when using headless w/ multiple
# cores, my guess is that I need to add some type of waiting
# when the results appear. Should be a good exercise
